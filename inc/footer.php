				...
				<div class="row row-pb-md">
					...
					<div class="col footer-col">
						...
						<ul class="colorlib-footer-links">
							...
							<li><a href="index.php" style="text-transform: lowercase;">www.footwear.bd.com</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="copy">
				<div class="row">
					<div class="col-sm-12 text-center">
						<p>
							<span>
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | www.footwear.bd.com</a></span> 
						</p>
					</div>
				</div>
			</div>
