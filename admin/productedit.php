...
if (!isset($_GET['editproduct']) || $_GET['editproduct']==NULL) {
  echo "<script>window.location='productlist.php'</script>";
    ...
    $eid = $_GET['editproduct'];
}
   $pd = new Product();
   $proedit = $pd->eidproduct($eid);
    if ($_SERVER['REQUEST_METHOD'] == 'POST' || isset($_POST['submit'])) {
        $updateProduct = $pd->productUpate($_POST, $_FILES, $eid);
   }
...
<div class="grid_10">
    <div class="box round first grid">
        ...
        <?php
            if ($proedit) {
               while ($value=$proedit->fetch_assoc()) {  
        ?>  
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                       <img src="<?php echo $value['image'];?>" width="50px" height="50px" />
                    </td>
                </tr>
